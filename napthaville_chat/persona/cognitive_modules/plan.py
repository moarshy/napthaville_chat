...
def generate_convo(maze_data: Dict, init_persona, target_persona) -> Tuple[List, int]:
    """
...
def generate_decide_to_talk(init_persona, target_persona_name, target_persona, retrieved) -> bool:
    """
    ...
    """
    decision = run_gpt_prompt_decide_to_talk(
...
def generate_decide_to_react(init_persona, target_persona_name, target_persona, retrieved) -> str:
    """
...
def _should_react(persona, retrieved: Dict, personas: Dict) -> Union[str, bool]:
    ...
    def lets_talk(init_persona, target_persona_name, target_persona, retrieved) -> bool:
        ...
        return generate_decide_to_talk(
            init_persona=init_persona, 
            target_persona_name=target_persona_name, 
            target_persona=target_persona, 
            retrieved=retrieved
...
async def plan(persona, maze_data, personas: Dict, new_day: Union[str, bool], retrieved: Dict, chat_deployment: Dict) -> str:
    """
    ...
    if focused_event:
        ...
        if reaction_mode:
            ...
            chat_data = await chat_run(chat_input_data)
...
def _chat_react(maze_data: Dict, persona, reaction_mode: str, personas: Dict):
    """
    ...
    convo, duration_min = generate_convo(maze_data, init_persona, target_persona)
